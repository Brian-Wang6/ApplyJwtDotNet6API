...
namespace TasksApi.Services
{
    public class UserService : IUserService
    {
        ...
        {
            var user = tasksDbContext.Users.SingleOrDefault(user => user.Active && user.Email.Equals(loginRequest.Email));
            if (user == null)
            {
        ...
        {
            var existingUser = await tasksDbContext.Users.SingleOrDefaultAsync(user => user.Email.Equals(signupRequest.Email));
