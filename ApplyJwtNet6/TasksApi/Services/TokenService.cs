...
namespace TasksApi.Services
{
    public class TokenService : ITokenService
    {
        ...
        public TokenService(TasksDbContext tasksDbContext, IOptions<JwtOption> options)
        {
        ...
        {
            var accessToken = await TokenHelper.GenerateAccessTokenAsync(userId, jwtOption);
            var refreshToken = await TokenHelper.GenerateRefreshTokenAsync();
            ...
            {
                ExpiryDate = DateTime.Now.AddDays(jwtOption.RefreshValidity),
                Ts = DateTime.Now,
                UserId = userId,
