    ...
    public partial class TasksDbContext : DbContext
    {
        ...
        private void SetupCommonConfigModels(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<RefreshToken>(entity => 
            {
                ...
                entity.HasOne(d => d.User).WithMany(p => p.RefreshTokens).HasForeignKey(d => d.UserId).OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<Entities.Task>(entity =>
            {
                ...
                entity.Property(e => e.Ts).HasColumnType("smalldatetime").HasColumnName("TS");
                entity.HasOne(d => d.User).WithMany(p => p.Tasks).HasForeignKey(d => d.UserId).OnDelete(DeleteBehavior.ClientSetNull)
